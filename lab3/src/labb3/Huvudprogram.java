...
public class Huvudprogram {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * ordentligt. Lägg varje uppsättning (även den givna nedan) i separata metoder
		 * här i klassen. Såna bör vara deklarerade static för att kunna anropas från
		 * main (som ju också är static).
		 */
...
//		minRum(rum);
		...
		/*
		 * TODO: Skapa en instans av klassen GUI och skicka med nivån ovan som argument.
		 * Man kan ha en referensvariabel som refererar till GUI-instansen men det är
		 * inte nödvändigt.
		 */
	...
	public static void minRum(ArrayList<Rum> rum) throws Exception {
		
		// Bredd - Höjd, X - Y Koordinater
...
//		Rum.kopplaIhop(rum.get(7), ÖSTER, rum.get(6), VÄSTER);
	...
	public static void lab3Rum(ArrayList<Rum> rum) throws Exception {

		// Dessa rum och gångar motsvarar de i laborationsinstruktionen.

		// X - Y Kordinater, Bredd - Höjd
		rum.add(new Rum(Color.RED, 75, 75, 25, 25));
		rum.add(new Rum(Color.BLUE, 75, 50, 50, 150));
		rum.add(new Rum(Color.MAGENTA, 100, 50, 175, 100));
		rum.add(new Rum(Color.YELLOW, 100, 75, 200, 200));
